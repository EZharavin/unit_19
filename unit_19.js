...
function t1() {
    return document.querySelector('.out-1').innerHTML = document.querySelector('.div-1').textContent;
}
...
function t2(e) {
    if (e.altKey == true) {
        return document.querySelector('.out-2').innerHTML = true;
    }
    else {
        return document.querySelector('.out-2').innerHTML = false;
    }
}
...
function t4() {
    return document.querySelector('.out-4').innerHTML = document.querySelector('.div-4').textContent;
}
...
function t18() {
    document.querySelector('.div-18').innerText = document.querySelector('.block').offsetWidth;
    // document.querySelector('.div-18').innerText = document.querySelector('.block').style.width;
}
...
function t19() {
    const inputIn = this.classList;

    this.innerHTML = '';

    for (let i = 0; i < inputIn.length; i++){
        this.innerHTML += inputIn[i] + '<br>';
    }

    this.style.fontSize = 11 + 'px';
}
